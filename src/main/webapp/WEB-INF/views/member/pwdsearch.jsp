			...
			<div class="content">
				<div class="signin-cont cont">
					<form action="pwdsearch" method="post">
						<input type="text" name="id" id="id" class="inpt" required="required" placeholder="ID를 입력해주세요">
						<label for="id">Your Id</label>
						<input type="text" name="name" id="name" class="inpt" required="required" placeholder="이름을 입력해주세요">
						<label for="name">Your Name</label>
						<input type="text" name="phone" id="phone" class="inpt" required="required" placeholder="휴대폰번호를 '-'없이 입력해주세요">
		...
		function pwdsearch() {
			...
			$.ajax({
				...
				success : function(result) {	
					...
					{
						alert("찾으시는 비밀번호는 "+ result.p +" 입니다.");
						 window.location.href="../member/pwd_reset?id="+id;
					}	
				},
